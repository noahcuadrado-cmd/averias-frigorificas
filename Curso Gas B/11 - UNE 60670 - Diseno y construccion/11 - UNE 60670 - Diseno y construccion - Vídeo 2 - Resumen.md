...
<p class="eyebrow">Tema 11 · Vídeo 2 de 3 · UNE 60670-4 · Diseño y construcción</p>

**Este es el corazón del tema.** Por dónde puede ir un tubo de gas y por dónde no; cuándo va visto, envainado, enterrado o empotrado; qué distancia debe guardar con la luz, el agua o una chimenea; cómo se grapa, se protege, se ventila y se señaliza. Todo lo que un inspector mira primero cuando llega a una instalación está en este bloque (capítulo 4 de la norma). Léelo despacio: aquí hay muchos valores concretos y muchas prohibiciones que caen tal cual en el examen.
...
- **Qué te llevas y para qué sirve.** Este es el vídeo del «por dónde sí y por dónde no». Modalidad del tubo, distancias, protección, ventilación y sellados son **lo primero que mira el inspector o la distribuidora** cuando llega a la obra. Dominarlo es la diferencia entre que la instalación pase a la primera o te la tumben.
- **Cuatro modalidades con una regla de oro: poder reparar sin picar.** Lo ideal es **visto** o **envainado** (accesible); **enterrado** solo por el exterior (según UNE 60311); **empotrado**, la excepción tasada. No confundas envainado (dentro de vaina) con empotrado (en la obra, a pelo): caen juntas en el examen y son cosas distintas en obra.
- **La lista negra es pregunta segura y seguridad real.** Nada de gas por ascensores, transformadores, locales domésticos con combustible líquido (salvo **clase C** y **≤ 1000 l**), bajantes de basura, chimeneas, conductos de ventilación ni dentro de forjados. La lógica: por donde suba fuego, humo, basura o electricidad gorda, el gas no pasa. Saltárselo es firmar la instalación que un día explica un incendio o una explosión.
- **Tuberías vistas: los dos treses y «no tocar nada».** **3 cm** a cualquier otro servicio (luz, agua, chimenea) en paralelo y en cruce, y **3 cm** al suelo, medidos de superficie a superficie. El tubo **nunca toca** otra tubería ni estructura metálica: el contacto genera **par galvánico y corrosión**, y ahí acabas teniendo una **picadura que se convierte en fuga** con los años. Si no llegas a los 3 cm, aíslas (coquilla de **400 V**, **−15/+80 °C**, UV si va fuera). Señaliza con **«gas»** o franja amarilla al menos una vez en zona común, para que nadie taladre a ciegas y pinche el tubo. Y **PE jamás visto**: el sol lo cuartea y fuga.
- **La vaina tiene cuatro «para qué»** (mecánica, ventilación, acceso a armarios, suelo/subsuelo) y sus materiales están en la **tabla 6**: **metal siempre** en protección mecánica y semisótano; plástico rígido admitido en el resto (rigidez anular ≥ 3 veces el diámetro); estanca donde lleve asterisco. La **vaina de ventilación** es continua, estanca y con **las dos bocas al exterior**, sellando siempre el extremo que da a un local sin ventilar: si no, la fuga se acumula justo donde no debe (semisótano, cámara, vivienda ajena) y tienes servida la intoxicación por CO o la explosión.
- **Semisótano suficientemente ventilado:** solo gas más ligero que el aire a **≤ 50 mbar**, con **S = 10 · A** y **mínimo 200 cm²**, dos rejillas en paredes opuestas separadas 2 m. El butano/propano, más pesados, no tienen esta excepción: se acumulan abajo.
- **Empotrado: máximo 0,40 m** (2,50 m solo hacia conjunto de regulación/contadores), **sin ninguna unión mecánica** escondida, con limpieza, imprimación y **doble capa de cinta al 50 % de solape**, y **prueba de estanquidad antes de tapar**. Una rosca empotrada o un tubo sin proteger es una **fuga oculta** que sale por la pared con olor a gas que nadie localiza y obliga a picar.
- **MOP > 2 bar y ≤ 5 bar:** por el exterior salvo casos inevitables; entonces envainado (con excepciones puntuales).
- **Papeleo.** El trazado se documenta con su **croquis o esquema** en el **certificado de instalación (modelo IRG)** que firma la empresa instaladora habilitada; y lo que se tapa (empotrado, envainado) se **prueba de estanquidad antes**, prueba que respalda ese certificado entregado a la distribuidora. Lo que no está probado y documentado, para el inspector no existe.
