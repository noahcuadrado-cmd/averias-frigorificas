...
- **Qué te llevas y para qué sirve.** La Parte 12 aplicada a lo **grande**: instalaciones individuales de **más de 70 kW** (con **estación de regulación y medida, ERM**) y las **instalaciones comunes** del edificio (montantes y recintos de contadores). Aquí lo que de verdad decide entre «sigue con gas» y «fuera de servicio» es un número: el **caudal de fuga en litros/hora**.
- **La escalera de los litros/hora (memorízala, cae fijo).** Gas **menos denso que el aire** (gas natural), en interior **no peligroso** y **midiendo**: **< 1 l/h → apta**; **1-5 l/h → pendiente de corrección** (secundaria ISb-1 / CS-1); **> 5 l/h → no apta** (principal IPb-1 / CP-1). Trampas de examen y de obra: **si no mides, siempre no apta**; y en **sala de máquinas** sin sistema de detección y corte de gas (**UNE 60601**), el listón baja a **> 1 l/h** para ser no apta.
- **El GLP no perdona.** Con **gas más denso que el aire** (GLP), **cualquier fuga es no apta, sin medir**: pesa, se acumula a ras de suelo y explota abajo. Y si la fuga está en **emplazamiento peligroso** (atmósfera explosiva, clasificada por el **Real Decreto 400/1996**, ATEX) o **no consigues localizarla**, tampoco hay medición que valga: **no apta**. El tramo **enterrado** se rige por la **UNE 60311**.
- **Con la ERM aparecen anomalías nuevas (todas secundarias, ISb).** A partir de 70 kW vigilas la **toma de tierra y las juntas dieléctricas** (ISb-5, para que no entren corrientes por la tubería y salte una chispa), la **ventilación y la ubicación** del recinto (ISb-6, ISb-7), la **instalación eléctrica** (ISb-9) y la **señalización** (ISb-10). Dato que cae tal cual: **extintor de polvo seco de 12 kg**, accesible, en el **exterior** del recinto y **revisado en fecha** (ISb-8); si falta, está deteriorado o caducado, anomalía.
- **La llave general que no se alcanza (ISb-4).** Puro sentido común de obra: la llave general de usuario tiene que **estar** y **poder accionarse sin acrobacias**. Si para cerrarla en una emergencia necesitas una escalera, abrir una trampilla o mover muebles, no sirve de nada — es anomalía.
- **Las comunes: misma escalera, otras siglas (CP/CS).** Mismos números de fuga que en individual grande; solo cambia que en común **no** existe el matiz de la sala de máquinas. El **recinto de contadores** debe estar **libre de instalaciones ajenas y de trastero** (CS-6, CS-7), con **puerta** en condiciones (CS-8) y **contadores y llaves identificados** (CS-10): en una emergencia, un contador sin etiquetar te obliga a **cortar a ciegas**.
- **Dónde miras las grietas: arriba o abajo según el gas (CS-9).** Detalle finísimo y muy preguntable. El **gas natural** sube (ligero) → grietas peligrosas **arriba** (techo y por encima de la rejilla superior); el **GLP** baja (pesado) → grietas **abajo** (suelo y por debajo de la rejilla inferior). Esas grietas **canalizan una fuga hacia la estructura del edificio**. *Natural, mira al techo; GLP, mira al suelo.*
- **El papeleo, igual que en toda la Parte 12.** Resultado favorable → **certificado**; con defectos → **informe de anomalías** (alcance, situación y plazo), siempre con **recomendaciones de seguridad**, entregado al **titular**; las **anomalías principales / no aptas** se **comunican a la empresa distribuidora**, que además es quien maneja la acometida y el cese del suministro.
