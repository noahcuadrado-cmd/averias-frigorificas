...
<p class="eyebrow">Tema 06 · Vídeo 3 de 3 · Reglamento · ITC-ICG 09</p>
...
- Norma **UNE 60670** sobre instalaciones receptoras de gas con MOP ≤ 5 bar, según la edición recogida en la **ITC-ICG 11**.
...
- **2.1.1.9 Dispositivos de protección y seguridad de aparatos:** definición; tipos: bimetálicos; termopares (con analizador de atmósferas); termostatos; órganos detectores sensibles a la luz (válvulas fotoeléctricas, fotoconductoras, tubos de descarga); órganos detectores por conductividad de la llama.
...
- **Ley 34/1998**, Título IV, **Capítulo IV** «Regasificación, transporte y almacenamiento de gas natural», la Disposición Adicional 6.ª y las Disposiciones Transitorias 5.ª, 7.ª, 8.ª y 15.ª (con las modificaciones del artículo 7 del Real Decreto-Ley 6/2000).
- Las siguientes ITC:
  - ITC-ICG 01 «Instalaciones de distribución de combustibles gaseosos por canalización».
  - ITC-ICG 03 «Instalaciones de almacenamiento de GLP en depósitos fijos».
  - ITC-ICG 05 «Estaciones de servicio para vehículos a gas».
...
- **3.1.1.11 Aparatos de gas:** cocción (tipos, conexiones, regulación, protección y seguridad, encendido); producción de ACS (instantánea y acumuladores); calefacción fijos (calderas de calefacción y ACS, radiadores murales, generadores de aire caliente); estufas móviles; aparatos «populares»; presiones de funcionamiento; comprobación del funcionamiento.
...
- El **anexo 1** fija los **conocimientos mínimos** (teóricos, prácticos y de reglamentación) por categoría; es la referencia del examen de la comunidad autónoma.
- Funciona por capas: **A = temario de B + extras** (polietileno, protección catódica, corrosión, depósitos fijos, zanjas, trasvase de GLP). En reglamentación, **B = A menos** (capítulo de gas natural de la Ley 34/1998 y las ITC **01, 03 y 05**), y **C = B menos** (más capítulos de la Ley 34/1998, las ITC **06 y 10** y la **UNE 60601**).
- El bloque de **UNE 60670** (tuberías/pruebas, contadores, ventilación) lo estudian **las tres** categorías. La **UNE 60601** (salas de máquinas), solo **A y B**.
- La **categoría C** tiene el temario más reducido: sin adaptación de aparatos a otras familias, sin depósitos móviles > 15 kg, sin inertización, con matemáticas y física recortadas.
- El **anexo 2** son los conocimientos «expertos» sobre aparatos: **4.1 exige apartados 1 a 17**; **4.2 (cambio de familia de gas) exige el anexo completo (1 a 18)**.
- No confundas los **tipos de aparato A/B/C** (evacuación de humos, UNE-CEN/TR 1749 IN) con las **categorías A/B/C del instalador**.
