...
<p class="eyebrow">Tema 02 · Resumen íntegro del tema · 4 vídeos</p>
...
Capacidad de un tipo de envase: **Ct = Cn × N × 0,65**
...
> **Nota aclaratoria — el 0,65 y los vacíos.** Se multiplica por un coeficiente de seguridad **0,65** y en **N** se cuentan **llenos Y vacíos** (una botella «vacía» nunca lo está del todo). La numeración va al revés: la **1.ª** es la mayor. Saltos clave: **500 / 1.000 / 12.500 / 25.000 / 250.000 kg**.

## 3 · Diseño y construcción de los centros

### 3.1 · Normas generales (todos salvo 5.ª categoría)
...
> **Nota aclaratoria — cerramiento y apilado.** Cerramiento: **muro EI 180 de 2,5 m** hacia la gente, **malla de 2 m** el resto, a **10 m** del almacenamiento. Apilado: la botella pequeña sube (**4 llenas / 6 vacías**), la grande no (**1 altura**).

> **Nota aclaratoria — agua e incendios.** Cifras que van juntas: **5 kg/cm²**, bocas **DN25**, **90 min** de autonomía; **6 bocas** en 1.ª y **2** en 2.ª/3.ª. En la tabla de extintores: un grande (**43A-183B**) equivale a dos pequeños (**21A-113B**).
...
Previa a la puesta en servicio, el **organismo de control** (asistido por la empresa de montaje y el director de obra) realiza las **pruebas en obra** de la **UNE 60210** (**resistencia y estanquidad**).
...
- Según **V × P** (V = volumen geométrico en m³; P = presión máxima de trabajo en bar):
  - **V × P ≤ 300:** especialista criogénico, servicio de mantenimiento del usuario u organismo de control.
  - **V × P > 300:** **necesariamente organismo de control**.
...
- **Certificado por cuadriplicado** del control satisfactorio (usuario, titular, órgano competente).
...
> **Nota aclaratoria — V×P y el 300; 5 y 15 años.** Si **V×P > 300**, control obligatorio por organismo de control. Control periódico **cada 5 años**; prueba de presión **neumática cada 15 años** (en GLP era hidráulica).
...
- **ITC-ICG 02 (envases de GLP):** cinco categorías por kg (**1.ª** 25.001–250.000 … **5.ª** hasta 500); capacidad **Ct = Cn × N × 0,65** (llenos y vacíos); almacenamiento **al aire libre**, evacuación **≤ 25 m**, envases llenos **en vertical**, **prohibido el trasvase**.
...
- **ITC-ICG 04 (GNL):** norma **UNE 60210**; hasta **1.000 m³**; **especialista criogénico**; **autorización previa** salvo autoconsumo; **siempre proyecto**; comunicación en **15 días hábiles**; control **cada 5 años** (organismo de control si **V×P > 300**); **prueba neumática cada 15 años**; **un año sin carga → inertizado**.
