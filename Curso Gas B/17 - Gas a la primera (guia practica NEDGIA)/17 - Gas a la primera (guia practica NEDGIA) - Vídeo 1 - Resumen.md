...
<p class="eyebrow">Tema 17 · Vídeo 1 de 3 · Guía práctica NEDGIA</p>
...
- En **obra nueva** es **obligatorio centralizar** contadores; el recinto va en **zona comunitaria**, **grado 2**, y **nunca por debajo del primer sótano** (gas más ligero que el aire).
- Altura del **totalizador**: **< 2 m** en centralizado (**2,40 m** en prefabricado UNE 60490 con escalera); **≤ 1,7 m** en contador dentro de la vivienda.
- Ventilación del recinto según **UNE 60490**: armarios pequeños (5-50 cm² y sin indirecta), locales y cuartos **200/150 cm²**; **+50%** por conducto **L > 3** y por **primer sótano** (puerta estanca).
- Regulador con **presión de entrada ≥ 150 mbar** → **válvula de máxima de rearme manual**; MPA de abonado según **UNE 60402 partes 1 y 2**.
- Puerta del recinto: **abre hacia fuera**, cerradura **normalizada**, **abrible desde dentro sin llave**, **toma de corriente** y cartel **«Contadores de gas»**.
- Contador en vivienda: cerca de la entrada, ventilado, **nunca bajo fregadero**; **≥ 40 cm** al quemador de cocina y **≥ 20 cm** en todo el perímetro a aparatos y mecanismos eléctricos; **prohibido** en dormitorio, W.C., baño y ducha.
- Accesibilidad (**UNE 60670-2**): **grado 1** sin llave ni escalera; **grado 2** con cerradura normalizada; **grado 3** con escalera o por zona privada. La **llave de usuario** siempre, **grado 2** para la distribuidora.
