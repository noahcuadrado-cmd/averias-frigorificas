...
<p class="eyebrow">Tema 03 · Vídeo 2 de 2 · Reglamento · ITC-ICG 06</p>

**Las bombonas «de verdad», con normativa.** Esta ITC regula las instalaciones de envases de GLP (butano y propano) que alimentan una instalación receptora para uso propio. Aquí es donde aparecen los números que más caen: capacidades máximas (300 kg, 1.000 kg, 70 kg), distancias de seguridad a hogares y enchufes, condiciones de armarios y casetas, y la prueba de estanquidad. La ITC parte en dos según el tamaño del envase: **hasta 15 kg** (bombona doméstica típica) y **más de 15 kg**. Domina las dos tablas de distancias y tendrás medio vídeo ganado.
...
- Los envases que, por su diseño y construcción, dispongan de los elementos adecuados para su **llenado en su emplazamiento** deben cumplir la **ITC de instalaciones de GLP en depósitos fijos** en lo relativo a su **clasificación, diseño, construcción y puesta en servicio**.
- La ejecución la realiza una **empresa instaladora de gas**.
...
> **Nota aclaratoria — la regla del interior y los 70 kg.** Por defecto, los envases grandes van **fuera, en caseta**. La única puerta para tenerlos **dentro** es que el contenido total sea **≤ 70 kg** Y el local sea grande y bien ventilado: **> 1.000 m3, ≥ 150 m2**, ventilación de **1/15** a ras de suelo y **dos extintores 21A-113B**. Memoriza el «70 kg» como la frontera «dentro/fuera» para envases > 15 kg.
...
Estas instrucciones **no son exigibles** cuando entre los envases y los elementos citados medie una distancia **superior a 20 m** si los envases están en el **interior** de locales, o **10 m** si están en el **exterior**. Las **dos últimas** precauciones (interruptores y motores) **no son precisas** si los motores eléctricos e interruptores están dotados de **modos de protección antiexplosiva**.
...
- La **ITC-ICG 06** regula los **envases de GLP para uso propio** con **carga unitaria > 3 kg** que alimentan una instalación receptora.
- Dos grupos: envases **≤ 15 kg** (tope total **300 kg**) y envases **> 15 kg** (tope total **1.000 kg**); en la suma cuentan **llenos y vacíos**.
- Prohibido en **sótanos, semisótanos, cajas de escalera y pasillos** (el GLP pesa y se embolsa); **regulador obligatorio** salvo presión directa con tubo rígido.
- **Cuadro 1** (≤ 15 kg): hogares **1,5 m**, tomas de corriente **0,5 m**, hornillos/interruptores/conductores **0,3 m**; reducciones con protección antirradiación (hasta **0,5 m** y **0,10 m**).
- Envases **> 15 kg**: normalmente en **caseta exterior**; sólo dentro si el contenido es **≤ 70 kg** y el local es **> 1.000 m3, ≥ 150 m2**, ventilación **1/15** y **dos extintores 21A-113B**.
- **Caseta**: material **A2-s3,d0**, ventilación **1/10** arriba y abajo (< 15 cm), piso inclinado al exterior; extintores en caseta si el contenido **sobrepasa 350 kg**.
- **Cuadro 2**: más contenido, más distancia; la **caseta** recorta distancias a **desagües y sótanos** (de 1,5 a 0,5 m).
- **Cambio de envases**: sin fuego, sin interruptores, sin motores (salvo > 20 m interior / > 10 m exterior o material antiexplosivo).
- **Prueba de estanquidad**: **1,5 × presión de operación**, **10 minutos**, con aire/gas inerte/GLP gaseoso → luego **certificado de instalación**.
- **Sin autorización y sin comunicación**; puesta en servicio junto con la receptora; control periódico como **revisión** (ITC-ICG 07), guardando el certificado de instalación.
