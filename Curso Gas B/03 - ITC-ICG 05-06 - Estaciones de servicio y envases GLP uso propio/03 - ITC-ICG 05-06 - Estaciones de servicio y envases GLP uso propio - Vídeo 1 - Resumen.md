...
<p class="eyebrow">Tema 03 · Vídeo 1 de 2 · Reglamento · ITC-ICG 05</p>

**La «gasolinera de gas».** Esta ITC regula las estaciones donde los coches y camiones repostan gas en lugar de gasolina o gasóleo: GLP a granel, gas natural comprimido (GNC), gas natural licuado (GNL) o hidrógeno. En este vídeo verás qué instalaciones entran, qué normas mandan según el tipo de gas, y todo el circuito de papeles hasta que la estación puede echar el primer suministro. Es una ITC corta pero con datos muy preguntables: normas UNE por combustible, plazos y periodicidades.
...
> **Nota aclaratoria —** Ojo a los cuatro combustibles que puede haber en una estación de repostaje: **GLP, GNC, GNL e hidrógeno**. No son intercambiables ni se regulan igual (cada uno tendrá su norma, como verás en el apartado 3). Truco de memoria: son «los gases que mueven vehículos». Si en el examen ves «gasóleo» o «gasolina» en esta lista, es falso: esta ITC va de **gases**.
...
> **Nota aclaratoria —** Separa mentalmente **GLP por un lado** (norma nacional **UNE 60630**) y el **resto de gases por otro** (marco europeo, la **Directiva 2014/94/UE** de combustibles alternativos). Y para GNC/GNL/H2, mientras Europa no aprieta el botón, cada gas tiene su norma «puente»: **16923 para GNC, 16924 para GNL, 19880-1 para hidrógeno**. Truco: los números **16923/16924** van casi seguidos, para el gas natural (comprimido y licuado); el hidrógeno, aparte (**19880-1**).
...
- En cada estación existirá un **Libro de Mantenimiento** (o archivo documental) con las **actas de todas las operaciones**, que estará en poder del **titular** y podrá ser consultado por el **órgano administrativo competente** cuando lo considere conveniente. Todas las intervenciones se registran, indicando **fecha, persona e intervención realizada**, y cada una la **firma** quien la realiza **y el titular**.
...
- La **ITC-ICG 05** regula estaciones de servicio de **GLP, GNC, GNL e hidrógeno** para vehículos, de **nueva construcción** y **ampliaciones**, de **acceso libre y restringido**.
- **Acceso restringido** = pocas personas con **formación específica** bajo responsabilidad del titular; el resto, **acceso libre**.
- Equipo de **GNC de uso propio < 10 m3/h y sin almacenamiento intermedio** queda **fuera**: se trata como **aparato a gas**.
- Normas de diseño: **GLP → UNE 60630**; **GNC/GNL/H2 → Directiva 2014/94/UE** y, transitoriamente, **UNE-EN ISO 16923 (GNC)**, **UNE-EN ISO 16924 (GNL)** e **ISO 19880-1 (H2)**.
- **No hay autorización** administrativa, pero **sí proyecto** de técnico facultativo competente. La instalación de gas la ejecuta **empresa instaladora de gas**.
- Circuito: **pruebas** (instaladora) → **inspección inicial** (organismo de control, con UNE 60250) → **certificados** → **disposición de servicio** → **primer suministro**.
- Comunicación a la Comunidad Autónoma: **por duplicado**, en **15 días hábiles** desde el **primer llenado**.
- Mantenimiento: **inspección periódica cada 5 años** por organismo de control y **cambio de mangueras al menos cada 5 años**; **Libro de Mantenimiento** en poder del titular.
