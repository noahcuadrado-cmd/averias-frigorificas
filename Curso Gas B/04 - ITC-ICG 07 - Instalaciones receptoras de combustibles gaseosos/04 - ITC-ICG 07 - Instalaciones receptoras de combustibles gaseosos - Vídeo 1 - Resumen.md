...
<p class="eyebrow">Tema 04 · Vídeo 1 de 3 · Reglamento · ITC-ICG 07 · núcleo Gas B</p>
...
- **Qué te llevas.** La **ITC-ICG 07** es tu manual de cabecera para la instalación receptora: manda en el **diseño, la ejecución y la utilización**, e incluye los **locales** (cocina, cuarto de contadores, sala de calderas) y los **aparatos** conectados. Todo lo que montas de la llave de acometida a la llave del aparato se rige por aquí.
- **Los humos son seguridad, no un trámite.** La evacuación es **por cubierta** salvo excepción. Una chimenea mal dimensionada o de material equivocado, o sacar los humos por fachada donde no toca, se traduce en obra real en **tiro insuficiente, retorno de productos de la combustión, condensaciones, ennegrecido y revocos en fachada** y, en el peor caso, **CO dentro de la vivienda**. Diseña y calcula con **UNE 123001 y UNE-EN 13384-1/-2**; material según **UNE-EN 1856-1** (metálica) o **NTE-ISH-74** (no metálica).
- **Las dos cifras de la salida a fachada.** Solo se permite salida directa al exterior en **estancos o de tiro forzado ≤ 70 kW** y en **tiro natural de solo ACS ≤ 24,4 kW**. Si te pasas y sacas por fachada, la puesta en servicio te la tumban y le creas un problema de humos al vecino.
- **El patio no es decorativo.** Un patio de ventilación corto o **tapado y sellado** es una trampa de gases: los aparatos conducidos no tiran, se apagan y acumulan CO. Ten a mano las superficies: **0,5 × NT (mín. 4 m²)** en edificio existente, **1 × NT (más de 6 m²)** en obra nueva y, si está techado, abertura permanente del **25 % (mín. 4 m²)**.
- **El extractor que mata el tiro.** El aparato de **circuito abierto conducido** respira del propio cuarto; en cocina solo si evitas que el **extractor mecánico le robe el tiro** (esa interacción provoca inversión de humos y CO al ambiente, con el aparato apagándose). Va bien en lavadero, galería, terraza o garaje individual. Excepción: los de **solo ACS** se libran de estas limitaciones.
- **La norma la elige la presión.** **≤ 5 bar → UNE 60670**; **> 5 bar → UNE 60620**. Equivocarte de norma es diseñar mal desde el minuto cero y arriesgarte a un rechazo en la puesta en servicio. Como categoría B trabajarás casi siempre con la **60670**.
- **Los equipos "gordos" van a sala de máquinas.** Calderas y equipos con potencia **conjunta > 70 kW** exigen **sala de máquinas conforme a UNE 60601**. Sin ella, la instalación no es legalizable.
- **Bajo tierra, otras reglas.** Tramos **enterrados → UNE 60310 y UNE 60311**, y **antes** de diseñar una acometida interior enterrada, **pregunta al distribuidor de qué material es su red**: enterrar un material incompatible es garantía de uniones defectuosas, corrosión y **fugas que no verás hasta que huelan**.
